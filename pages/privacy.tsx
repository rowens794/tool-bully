...
export default function privacy({}: Props) {
  return (
    <>
      <Header />
      <div className="max-w-3xl mx-auto mt-24 text-gray-900">
        ...
        identify an individual in context. <br /> <br />
        ...
        blog, website or app? <br /> <br />
        When ordering or registering on our site, as appropriate, you may be
        asked to enter your name, email address or other details to help you
        with your experience. <br /> <br />
        When do we collect information? <br /> <br />
        We collect information from you when you subscribe to a newsletter or
        enter information on our site. Provide us with feedback on our products
        or services How do we use your information?
        <br /> <br /> We may use the information we collect from you when you
        ...
        <br /> <br /> • To personalize your experience and to allow us to
        deliver the type of content and product offerings in which you are most
        interested.
        <br /> <br /> • To quickly process your transactions.
        <br /> <br /> • To send periodic emails regarding your order or other
        products and services.
        <br /> <br /> How do we protect your information? <br /> <br />
        We do not use vulnerability scanning and/or scanning to PCI standards.
        We only provide articles and information. We never ask for credit card
        numbers. We use regular Malware Scanning. Your personal information is
        ...
        <br /> <br /> We implement a variety of security measures when a user
        ...
        gateway provider and are not stored or processed on our servers. Do we
        use ‘cookies’? <br /> <br />
        ...
        the correct way to modify your cookies. If you turn cookies off, Some of
        ...
        <br /> <br /> Third-party disclosure <br /> <br />
        ...
        <br /> <br /> Occasionally, at our discretion, we may include or offer
        ...
        our site and other sites on the Internet. Users may opt-out of the use
        of the DART cookie by visiting the Google Ad and Content Network privacy
        policy.
        <br /> <br /> We have implemented the following:
        <br /> <br /> • Remarketing with Google AdSense
        <br /> <br /> • Google Display Network Impression Reporting
        <br /> <br /> • Demographics and Interests Reporting
        <br /> <br /> • DoubleClick Platform Integration We, along with
        ...
        data regarding user interactions with ad impressions and other ad
        service functions as they relate to our website. Opting out: Users can
        ...
        Out Browser add on. California Online Privacy Protection Act CalOPPA is
        ...
        <br /> <br /> • On our Privacy Policy Page Can change your personal
        information:
        <br /> <br /> • By emailing us How does our site handle Do Not Track
        signals? <br /> <br />
        We honor Do Not Track signals and Do Not Track, plant cookies, or use
        advertising when a Do Not Track (DNT) browser mechanism is in place.
        Does our site allow third-party behavioral tracking? It’s also important
        to note that we allow third-party behavioral tracking COPPA (Children
        Online Privacy Protection Act) When it comes to the collection of
        ...
        under the age of 13 years old. Fair Information Practices The Fair
        Information Practices Principles form the backbone of privacy law in the
        ...
        laws that protect personal information. In order to be in line with Fair
        Information Practices we will take the following responsive action,
        should a data breach occur:
        <br /> <br /> We will notify you via email
        <br /> <br /> • Within 7 business days We will notify the users via
        in-site notification
        <br /> <br /> • Within 7 business days We also agree to the Individual
        ...
        <br /> <br /> • Market to our mailing list or continue to send emails to
        our clients after the original transaction has occurred.
        <br /> <br /> To be in accordance with CANSPAM, we agree to the
        following:
        <br /> <br /> • Not use false or misleading subjects or email addresses.
        <br /> <br /> • Identify the message as an advertisement in some
        reasonable way.
        <br /> <br /> • Include the physical address of our business or site
        headquarters.
        <br /> <br /> • Monitor third-party email marketing services for
        compliance, if one is used. • Honor opt-out/unsubscribe requests
        quickly.
        <br /> <br /> • Allow users to unsubscribe by using the link at the
        bottom of each email. If at any time you would like to unsubscribe from
        receiving future emails, you can email us at • Follow the instructions
        at the bottom of each email. and we will promptly remove you from ALL
        ...
        {site.url} <br /> <br />
        {site.email}
        <br /> <br /> Last Edited on Jan 1, 2023
        <br /> <br />
        <br /> <br />
      </div>
      <Footer />
